...
/**
 * When an activity hosts a keyboardView, this class allows several AppCompatEditText's
 * to register for it.
 *
...
public class CustomKeyboard extends InputMethodService{
    ...
    private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener() {
        ...
        public void onKey(final int primaryCode, int[] keyCodes) {
            ...
            // primaryCode
            // Get the AppCompatEditText and its Editable
...
//                    edittext.setSelection(textLength);
            ...
            // touched================
            // ((AppCompatEditText)mHostActivity.findViewById(R.id.et_enter_id_landing)).requestFocus();
            //
            //
            // }
     ...
     * Note that to enable AppCompatEditText's to use this custom keyboard, call the
...
//        super(host);
    ...
    /**
     * Register <var>AppCompatEditText<var> with resource id <var>resid</var> (on the
     * hosting activity) for using this custom keyboard.
     *
     * @param resid
     *            The resource id of the AppCompatEditText that registers to the custom
     *            keyboard.
     */
    public void registerEditText(int resid) {
        // Find the AppCompatEditText 'resid'
